    ...
    <div className="min-h-screen flex items-center justify-center bg-gray-50 dark:bg-[#121212] py-12 px-4 sm:px-6 lg:px-8 w-full font-sans">
      ...
      >
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-500 dark:text-gray-400 font-medium">Enter your credentials to access your workspace.</p>
        </div>
        ...
        <div className="text-center">
          <Link to="/register" className="text-accent hover:underline text-sm font-bold">
